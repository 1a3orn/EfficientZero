...
class AtariConfig(BaseConfig):
    def __init__(self):
        ...
        self.resnet_fc_reward_layers = [8] #[32]  # Define the hidden layers in the reward head of the dynamic network
        self.resnet_fc_value_layers = [8] #[32]  # Define the hidden layers in the value head of the prediction network
        self.resnet_fc_policy_layers = [8] #[32]  # Define the hidden layers in the policy head of the prediction network
