...
class AtariConfig(BaseConfig):
    def __init__(self):
        super(AtariConfig, self).__init__(
            ...
            last_steps=20000,
            test_interval=100, #10000,
            log_interval=50, #1000,
            vis_interval=50, #1000,
            test_episodes=32,
        ...
        self.resnet_fc_reward_layers = [4] #[32]  # Define the hidden layers in the reward head of the dynamic network
        self.resnet_fc_value_layers = [4] #[32]  # Define the hidden layers in the value head of the prediction network
        self.resnet_fc_policy_layers = [4] #[32]  # Define the hidden layers in the policy head of the prediction network
